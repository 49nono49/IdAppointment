...
while True : 
    ...
    try:
        ...
        element = driver.find_element(By.XPATH, '//*[text()="Aucun créneau disponible à la prise de rdv par internet pour votre sélection. Merci de modifier votre sélection."]')
